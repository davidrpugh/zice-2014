...
% CDFs that cross twice---create second CDF using piecewise polynomials

function [breaks,coefs,nparts,ncoefs,d] = genpiecewiseCDFs_twocross( ...
    vlow,vhigh,zz)


% CDF values of second (piecewise) distribution
x = [0 1/6 1/3 1/2 2/3 5/6 1];
y = [0 1/9 1/3 5/9 2/3 7/9 1];

% valuations at which two cdfs are equal
%fprintf('CDFs cross at v = %.16f and v = %.16f\n\n',1/3,2/3)
